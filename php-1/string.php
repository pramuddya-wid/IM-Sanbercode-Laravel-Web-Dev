...
<body>
    ...
    */
    ...
    echo "Jumlah Kata: " . str_word_count($first_sentence) . " kata" . "<br>" . "<br>";
    ...
    echo "Jumlah Kata: " . str_word_count($second_sentence) . " kata" . "<br>";
    ...
    */
    ...
    echo "Kalimat baru: " . str_replace("sexy", "awesome", $string3)
